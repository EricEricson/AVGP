================================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: WAV-MP3-Encoder-Projektübersicht
===============================================================================

Diese WAV-MP3-Encoder-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt. Diese Anwendung zeigt nicht nur die Grundlagen der Verwendung von Microsoft Foundation Classes, sondern dient auch als Ausgangspunkt für das Schreiben Ihrer Anwendung.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre WAV-MP3-Encoder-Anwendung besteht.

WAV-MP3-Encoder.vcxproj
...
WAV-MP3-Encoder.vcxproj.filters
...
WAV-MP3-Encoder.h
    ...
    Sie enthält andere projektspezifische Header (einschließlich Resource.h) und deklariert die CWAVMP3EncoderApp-Anwendungsklasse.

WAV-MP3-Encoder.cpp
    Dies ist die wichtigste Anwendungsquelldatei, die die Anwendungsklasse CWAVMP3EncoderApp enthält.
...
res\WAV-MP3-Encoder.ico
    Dies ist eine Symboldatei, die als Anwendungssymbol verwendet wird. Dieses Symbol ist in der Hauptressourcendatei WAV-MP3-Encoder.rc enthalten.

res\WAVMP3Encoder.rc2
...
WAV-MP3-EncoderDlg.h, WAV-MP3-EncoderDlg.cpp - das Dialogfeld
    Diese Dateien enthalten Ihre CWAVMP3EncoderDlg-Klasse. Diese Klasse definiert das Verhalten des Hauptdialogfelds der Anwendung. Die Vorlage für das Dialogfeld befindet sich in WAV-MP3-Encoder.rc und kann in Microsoft Visual C++ bearbeitet werden.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen WAV-MP3-Encoder.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
